...
sudo pacman -S --noconfirm --needed gparted vlc ark signal-desktop
sudo pacman -S --noconfirm --needed curl qt5ct qt5-wayland 
sudo pacman -S --noconfirm --needed xfce4-terminal ristretto
...
paru -S --noconfirm snapper-gui wlogout wayland-logout 
 # apps i like 
paru -S --noconfirm github-desktop-bin swww nerd-fonts-git
#themes 
